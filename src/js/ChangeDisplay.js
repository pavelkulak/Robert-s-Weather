...
controlDomElements.hiddenElementsLanguage.forEach(function(el) {
    ...
    if (elNameLanguage.innerText == window.localStorage.getItem("language")) {
        ...
        controlDomElements.nameLanguage.innerText = window.localStorage.getItem("language")
    }
    else {
...
controlDomElements.changeLanguage.addEventListener("click", function(e) {
    controlDomElements.hiddenListLanguages.classList.toggle("hidden-by-display")
    ...
    if (elementLanguage.querySelector(".control__hidden-element-language-name").innerText === controlDomElements.nameLanguage.innerText) return
    ...
    controlDomElements.nameLanguage.innerText = elementLanguage.querySelector(".control__hidden-element-language-name").innerText
    getTodayWeather(controlDomElements.nameLanguage.innerText, window.localStorage.getItem("curTypeTemp"))
    getThreeDaysWeather(controlDomElements.nameLanguage.innerText, window.localStorage.getItem("curTypeTemp"))


    // Меняю язык у "ширина" и "долгота"
    mapDomElements.latitudeName.innerText = translate("Latitude", controlDomElements.nameLanguage.innerText.toLowerCase()) 
    mapDomElements.longitudeName.innerText = translate("Longitude", controlDomElements.nameLanguage.innerText.toLowerCase())

    window.localStorage.setItem("language", controlDomElements.nameLanguage.innerText)
})
...
controlDomElements.searchCityButton.addEventListener("click", function(e) {
    ...
    if (city) {
        getTodayWeather(controlDomElements.nameLanguage.innerText, window.localStorage.getItem("curTypeTemp"), city);
        getThreeDaysWeather(controlDomElements.nameLanguage.innerText, window.localStorage.getItem("curTypeTemp"), city);
